...
const ConnectedDashboardViewerRoute = connect(
    createSelector([
...
ConnectedDashboardViewerRoute.displayName = 'ConnectedDashboardViewerRoute';

export default ConnectedDashboardViewerRoute;
