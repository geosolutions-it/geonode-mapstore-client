...
const extendedPluginsDef = require("@extend/jsapi/previewPlugins");
const extendedPlugins = extendedPluginsDef.plugins || {};
const extendedRequires = extendedPluginsDef.requires || {};
